...
<html>
  ...
  <body style="background-image:url('img1.png'); background-size:cover">
...
<div class="row">
	<aside class="col-sm-4" style="visibility:hidden">
...
<article class="card-body">
    ...
    <div class="form-group">
        <form action="adminSearch.php"><input name="" class="form-control" placeholder="Email or login" type="email">
    </div> <!-- form-group// -->
    <div class="form-group">
...
<p><button class="btn btn-warning" target="_blank" onclick="window.location.href='sign-up2.php'"> Sign up as an owner now!
 <i class="fa fa-window-restore "></i></button></p>
</div>
<br><br><br>
</article>
  </body>
